...
<fieldset>
    <legend>Entrez vos identifiants :</legend>
        <label for="mail">Votre adresse email </label> <input type="text" placeholder="Adresse email" name="mail" id="mail" value="<?php  if (isset($_SERVER['user'])==true) { echo $_SERVER['user']; } ?>" required="required" /> <br />
